...
def main():
    ...
    Example: 
        esm_export_alarms -s 2018-01-01T00:00:00 -e 2018-07-23T00:00:00
    ...
    #esm_users = esm.get_users(passwd=passwd)
    #user_list = [x['username'] for x in esm_users]
    #for user in user_list:
        #alarms = esm.export_alarms(user=user, start=start, end=end)
